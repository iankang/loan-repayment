...
import com.loaning.loanrepay.exceptions.LoanException;
...
public class LoanService {
    ...
    public LoanService(LoansRepository loansRepository, SubscriberRepository subscriberRepository, SubscriberService subscriberService) {
            ...
            if (subscriberService.subscriberExistsByPhoneNumber(phoneNumber)){
                ...
                if(subscriber != null){
                    if(borrowAmount.compareTo(subscriber.getBorrowableAmount()) < 0){
                        ...
                        return new ResponseEntity<>(new LoanException("error").getMessage(),HttpStatus.BAD_REQUEST);
                    }
                }
            }else {
                return new ResponseEntity<>(HttpStatus.NOT_FOUND);
